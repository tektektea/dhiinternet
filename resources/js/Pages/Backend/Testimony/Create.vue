<template>
    <q-page class="container " padding>
        <q-breadcrumbs gutter="md">
            ...
            <q-breadcrumbs-el @click="$inertia.get(route('testimony.index'))" label="Testimony" />
            <q-breadcrumbs-el @click="$inertia.get(route('testimony.create'))" label="New Testimony" />
        </q-breadcrumbs>
        <br/>
        <div class="flex justify-between items-center bg-white q-pa-md">
            <div class="text-lg text-dark text-weight-medium">New Testimony</div>
        </div>
        <br/>
...
const handleSubmit=e=>{
    form.post(route('testimony.store'),{
